...
### [First example fittings example](https://github.com/DimensionDataCBUSydney/plumbery-contrib/tree/master/fittings/example/first)
...
### [Demonstrates how to configure a server with multiple disks](https://github.com/DimensionDataCBUSydney/plumbery-contrib/tree/master/fittings/example/disks)
...
### [Plumbery and Apache Libcloud installed in the cloud.](https://github.com/DimensionDataCBUSydney/plumbery-contrib/tree/master/fittings/example/beachhead)
...
### [Demonstrates how plumbery is working in parallel to deploy a large number of nodes.](https://github.com/DimensionDataCBUSydney/plumbery-contrib/tree/master/fittings/example/gigafox)
...
### [Docker node that you can access remotely and securely over the Internet.](https://github.com/DimensionDataCBUSydney/plumbery-contrib/tree/master/fittings/containers/docker)
...
### [Docker Swarm, with one queen and 7 bees.](https://github.com/DimensionDataCBUSydney/plumbery-contrib/tree/master/fittings/containers/docker-swarm)
...
### [Mesosphere cluster with Docker, on 3 masters and 9 slaves](https://github.com/DimensionDataCBUSydney/plumbery-contrib/tree/master/fittings/containers/mesosphere-cluster)

<img src='https://raw.githubusercontent.com/DimensionDataCBUSydney/plumbery-contrib/master/fittings/containers/mesosphere-cluster/icon.png' style='width: 64px;'/>
...
### [Confluence server](https://github.com/DimensionDataCBUSydney/plumbery-contrib/tree/master/fittings/applications/confluence)
...
### [iTop server for open-source ITSM](https://github.com/DimensionDataCBUSydney/plumbery-contrib/tree/master/fittings/applications/itop)
...
### [MongoDB cluster](https://github.com/DimensionDataCBUSydney/plumbery-contrib/tree/master/fittings/database/mongodb-cluster)
...
### [MySQL replication across two data centres](https://github.com/DimensionDataCBUSydney/plumbery-contrib/tree/master/fittings/database/mysql-master-slave)
...
### [Stackstorm server](https://github.com/DimensionDataCBUSydney/plumbery-contrib/tree/master/fittings/devops/stackstorm)
...
### [Centralised logging with Elasticsearch, Logstash, and Kibana.](https://github.com/DimensionDataCBUSydney/plumbery-contrib/tree/master/fittings/logging/elasticsearch-kibana-logstash)
...
### [These fittings plan are aiming to deploy multiple pingers connected](https://github.com/DimensionDataCBUSydney/plumbery-contrib/tree/master/fittings/logging/mqtt-swarm)
...
### [OpenVPN standalone server](https://github.com/DimensionDataCBUSydney/plumbery-contrib/tree/master/fittings/networking/openvpn)
...
### [Cluster of Ceph servers.](https://github.com/DimensionDataCBUSydney/plumbery-contrib/tree/master/fittings/storage/ceph)
...
### [NFS client and server at two different data centres](https://github.com/DimensionDataCBUSydney/plumbery-contrib/tree/master/fittings/storage/nfs)
...
### [Demonstration of a standalone Owncloud file server](https://github.com/DimensionDataCBUSydney/plumbery-contrib/tree/master/fittings/storage/owncloud)
...
### [Standalone Apache 2 web server.](https://github.com/DimensionDataCBUSydney/plumbery-contrib/tree/master/fittings/web/apache2)
...
### [Cluster of Apache web servers behind a load-balancer.](https://github.com/DimensionDataCBUSydney/plumbery-contrib/tree/master/fittings/web/apache2-cluster)
...
### [Linux-Nginx-MySQL-PHP standalone web server](https://github.com/DimensionDataCBUSydney/plumbery-contrib/tree/master/fittings/web/lemp)
...
### [Standalone nodejs server](https://github.com/DimensionDataCBUSydney/plumbery-contrib/tree/master/fittings/web/nodejs)
